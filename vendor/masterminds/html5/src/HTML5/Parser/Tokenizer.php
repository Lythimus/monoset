...
class Tokenizer
{
    ...
    protected function doctype()
    {
        ...
        variables.$white = strlen($this->scanner->whitespace());

        // Get ID, and flag it as pub or system.
        if (($pub == 'PUBLIC' || $pub == 'SYSTEM') && variables.$white > 0) {
            // Get the sys ID.
    ...
    protected function processingInstruction()
    {
        ...
        if (strlen($procName) == 0 || variables.$white == 0 || $this->scanner->current() == false) {
